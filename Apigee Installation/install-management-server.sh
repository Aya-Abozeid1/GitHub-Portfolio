...
sudo ln -Ts /u01/apigee/apigee /opt/apigee
sudo chown -h apigee:apigee /u01/apigee/apigee /opt/apigee
...
unset _JAVA_OPTIONS
# Datastore cluster
/opt/apigee/apigee-setup/bin/setup.sh -p ds -f /u01/apigee/software/configFile

# Install Management Server
/opt/apigee/apigee-setup/bin/setup.sh -p ms -f /u01/apigee/software/configFile

# last after all node have fineshed
...
/opt/apigee/apigee-service/bin/apigee-service apigee-validate setup -f /u01/apigee/software/configFile

/opt/apigee/apigee-service/bin/apigee-service apigee-validate clean -f /u01/apigee/software/configFile
...
JRE / JDK version or do not upgrade beyond OpenJDK 1.8.0.322.b06
